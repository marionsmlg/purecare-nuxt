  ...
  >
    ...
    <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
      <p class="text-sm leading-6 text-gray-900">
        ...
        <span class="font-bold">profil beauté</span> ?
        <span class="font-bold">Inscrivez-vous</span> et retrouvez toutes vos
        recettes dans votre espace personnel !
      </p>
      <NuxtLink
        to="/sign-up"
        ...
        >S'inscrire <span aria-hidden="true">&rarr;</span></NuxtLink
      >
    </div>
